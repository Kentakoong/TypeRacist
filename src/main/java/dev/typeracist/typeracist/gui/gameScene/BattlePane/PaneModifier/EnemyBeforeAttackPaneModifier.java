...
public class EnemyBeforeAttackPaneModifier extends BasePaneModifier {
    public EnemyBeforeAttackPaneModifier(BattlePane battlePane, BattlePaneStateContext context) {
