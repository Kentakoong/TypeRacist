...
public class GamePlayerStatsOptionPaneModifier extends BasePaneModifier {
    public GamePlayerStatsOptionPaneModifier(BattlePane battlePane, BattlePaneStateContext context) {
    ...
    public void initialize(BattlePaneStateManager manager) {
        ...
        playerStats.setFont(ResourceManager.getFont(ResourceName.FONT_DEPARTURE_MONO, 18));
