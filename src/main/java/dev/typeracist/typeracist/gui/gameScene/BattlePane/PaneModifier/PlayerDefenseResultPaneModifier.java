...
public class PlayerDefenseResultPaneModifier extends BasePaneModifier {
    ...
    public void initialize(BattlePaneStateManager manager) {
        ...
        int damageTaken = context.getEnemy().attack(GameLogic.getInstance().getSelectedCharacter(), rawDefenseScore);
        ...
        Label attackedScoreLabel = new Label(context.getEnemy().getName() + " attacked you by " + damageTaken + " damages");
                        ...
                        ae -> {
                            ...
                            fadeIn.setOnFinished(event -> {
                                ...
                                battlePane.setOnKeyPressed(keyEvent -> {
                                    ...
                                    manager.setReversibleState(BattlePaneState.PLAYER_DEFENSE_RESULT);
                                    returnControl();
                                });
                            });
